    ...
    return (
        <div className="no-scrollbar flex-1 h-[95vh] overflow-y-scroll flex flex-col justify-between">
            <form onSubmit={onSubmitHandler} className="md:p-10 p-4 space-y-5 max-w-lg">
                ...
                <button className="px-8 py-2.5 border bg-primary hover:bg-primary-dull transition-all active:bg-white active:text-primary active:border-primary text-white font-medium rounded">ADD</button>
            </form>
        </div>
    )
}
